    ...
    <div class="col-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="proceeding" name="proceeding" value="<?= isset($submission_details['proceeding']) ? $submission_details['proceeding'] : '-'  ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="doi" name="doi" value="<?= isset($submission_details['doi']) ? $submission_details['doi'] : '-' ?>" disabled>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="issn">ISSN</label>
                                    <input type="text" class="form-control" id="issn" name="issn" value="<?= isset($submission_details['issn']) ? $submission_details['issn'] : '-'; ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="publication-year" name="publication-year" value="<?= isset($submission_details['publication-year']) ? $submission_details['publication-year'] : '-' ?>" disabled>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="page">Halaman</label>
                                    <input type="text" class="form-control" id="page" name="page" value="<?= isset($submission_details['page']) ? $submission_details['page'] : '-' ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="volume" name="volume" value="<?= isset($submission_details['volume']) ? $submission_details['volume'] : '-' ?>" disabled>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="number">Nomor</label>
                                    <input type="text" class="form-control" id="number" name="number" value="<?= isset($submission_details['number']) ? $submission_details['number'] : '-' ?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="<?= site_url('submissions') ?>" class="btn btn-danger">Kembali</a>
