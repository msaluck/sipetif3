    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">DETAIL USULAN <?= $submission_type_id; ?></h3>
            ...
            <div class="card-body">
                <form action="<?= $action; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="proposer" name="proposer" value="<?= $this->session->name ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="proceeding">Nama Proceeding</label>
                                        <input type="text" class="form-control" id="proceeding" name="proceeding" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-6 collapse">
                                ...
                                <div class="col-12">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <input type="submit" value="Upload" class="input-group-text upload-proceeding-document" name="upload">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 table-responsive">
                                    <table class="table table-striped" id="uploaded-proceeding-document-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nama Dokumen</th>
                    ...
                    <input type="submit" class="btn btn-primary float-right" name="submit" value="Submit" disabled hidden />
                    <input type="submit" class="btn btn-secondary float-right" style="margin-right: 5px;" name="draft" value="Draft" />
                </form>
            </div>
        </div>
    </div>
