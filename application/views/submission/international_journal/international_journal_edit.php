                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="proposer" name="proposer" value="<?= $submission_details['proposer']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" id="manuscript-title" name="manuscript-title"><?= $submission_details['manuscript-title']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="proceeding" name="proceeding" value="<?= $submission_details['proceeding']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="doi" name="doi" value="<?= $submission_details['doi']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="issn">ISSN</label>
                                                <input type="text" class="form-control" id="issn" name="issn" value="<?= $submission_details['issn']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="publication-year" name="publication-year" value="<?= $submission_details['publication-year']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="page">Halaman</label>
                                                <input type="text" class="form-control" id="page" name="page" value="<?= $submission_details['page']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="volume" name="volume" value="<?= $submission_details['volume']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="number">Nomor</label>
                                                <input type="text" class="form-control" id="number" name="number" value="<?= $submission_details['number']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
