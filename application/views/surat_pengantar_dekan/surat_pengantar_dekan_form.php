        ...
        <div class="card card-success">
            <div class="card-header">
                <div class="card-title">
                    <i class="fa fa-tasks"></i> <?= $button ?> Data Surat pengantar dekan
                </div>
            ...
            <div class="card-body">
                <form style="padding: 15px;" action="<?= $action; ?>" method="POST" enctype="multipart/form-data">
					<div class="form-group">
                        <div class="row">
                            <label class="col-md-2" for="tinyint">Acc Dekan</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="acc_dekan" id="acc_dekan" placeholder="Acc Dekan" value="<?= $acc_dekan; ?>" />
                                <?= form_error('acc_dekan') ?>
                            </div>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="row">
                            <label class="col-md-2" for="timestamp">Createdate</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="createdate" id="createdate" placeholder="Createdate" value="<?= $createdate; ?>" />
                                <?= form_error('createdate') ?>
                            </div>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="hal" id="hal" placeholder="Hal" value="<?= $hal; ?>" />
                                <?= form_error('hal') ?>
                            </div>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="nama_jurnal" id="nama_jurnal" placeholder="Nama Jurnal" value="<?= $nama_jurnal; ?>" />
					...
					<div class="form-group">
                        <div class="row">
                            <div class="col-md-6 offset-md-2">
                                ...
                                <a href="<?= site_url('surat_pengantar_dekan') ?>" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
				</form>
