...
class Book_documents_by_all extends CI_Controller
{
    ...
    {
        $data = array(
            'book_documents_data' => $this->Book_documents_model->get_all(),
        );
        $this->template->load('layout/master', 'book_documents/book_documents_by_all_list', $data);
    }
