...
class Surat_pengatar_dekan extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Surat_pengatar_dekan_model');
    ...
    {
        $data = array(
            'surat_pengatar_dekan_data' => $this->Surat_pengatar_dekan_model->get_all(),
        );
        $this->template->load('layout/master','surat_pengatar_dekan/surat_pengatar_dekan_list', $data);
    }

    public function read($id) 
    {
        $row = $this->Surat_pengatar_dekan_model->get_by_id($id);
        if ($row) {
            $data = array(
				'id' => $row->id,
            ...
            $this->template->load('layout/master','surat_pengatar_dekan/surat_pengatar_dekan_read', $data);
        } else {
            $this->session->set_flashdata('toastr-error', 'Data Tidak Ditemukan');
            redirect(site_url('surat_pengatar_dekan'));
        }
    }
    ...
    public function create() 
    {
        ...
        $this->template->load('layout/master','surat_pengatar_dekan/surat_pengatar_dekan_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Surat_pengatar_dekan_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Ubah',
                'action' => site_url('surat_pengatar_dekan/update_action'),
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Surat_pengatar_dekan_model->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Surat_pengatar_dekan_model->delete($id);
...
/* End of file Surat_pengatar_dekan.php */
/* Location: ./application/controllers/Surat_pengatar_dekan.php */
